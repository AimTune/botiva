...
Needs: pip install langgraph  (>= 0.2; no model provider required)
    ...
    python examples/python/langgraph_server.py               # from the repo root, server on :8796
    python examples/python/langgraph_server.py --selftest    # + scripted client, exit 0/1
...
from botiva_langgraph import LangGraphRuntime  # noqa: E402
